...
export default class StudentForm extends Mixins(GlobalMixin) {
  ...
  tempStudent: Student = new Student() // will store a copy of the values from the student declared in the props section
  ...
  cancel () {
    ...
    this.tempStudent = Object.assign({}, this.student)// copy the student values to a new temp student
  ...
  // this student binding is from the student in AutoSearch.vue
